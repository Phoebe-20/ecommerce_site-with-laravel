...
@section('content')
    ...
    <main class="main">
        ...
        <div class="page-content">
                        ...
                        <div class="col-md-6">
                            <div class="product-details">
                                ...
                                <div class="product-price">
                                    cfa <span id="getTotalPrice">{{number_format($getProduct->price, 2) }}</span>
                                </div>
                                ...
                                <form action="{{ url('frontend/product/add-to-cart') }}" method="post">
                                    ...
                                    @if (!empty($getProduct->getSize->count()))
                                        <div class="details-filter-row details-row-size">
                                            ...
                                            <div class="select-custom">
                                                <select name="size_id" id="size" class="form-control getSizePrice" required>
                                                    <option data-price="0" value="#" >Choisir une taille</option>
                                                    @foreach ( $getProduct->getSize as $size)
                                                        <option data-price="{{ !empty($size->price) ? $size->price : 0 }}" value="{{ $size->id }} ">{{ $size->name }} @if(!empty($size->price)) (cfa {{ number_format($size->price, 2) }}) @endif</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-details-action">
                                        <button style="background: #fff;color: #c96;" type="submit" class="btn-product btn-cart">Ajouter au Panier</button>

                                        <div class="details-action-wrapper">
                                            <a href="#" class="btn-product btn-wishlist" title="favories"><span>Ajouter aux Favories</span></a>
            ...
            <div class="product-details-tab product-details-extended">
                <div class="container">
                    <ul class="nav nav-pills justify-content-center" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="product-info-link" data-toggle="tab" href="#product-info-tab" role="tab" aria-controls="product-info-tab" aria-selected="false">Plus d'informationnsur le produits</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container">
                <h2 class="title text-center mb-4">Vous pouriez aussi aimer</h2>
