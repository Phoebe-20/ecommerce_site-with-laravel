                        ...
                        @csrf
                          ...
                          <div class="card-body">
                            <div class="form-group">    
                                ...
                                <input type="text" class="form-control" required name="name" value="{{ old('name', $getRecord->name) }}" placeholder="Enter Sub Category Name">
                                @error('name')
                          ...
                          <div class="card-body">
                            <div class="form-group">    
                              ...
                              <input type="text" class="form-control" name="description" value="{{ old('description', $getRecord->description) }}" placeholder="Enter Category Description">
                              @error('description')
                                <span class="text-danger">{{ $message }}</span>
                              @enderror
                            </div>
